...
//HPC-1 Fall-2016 Homework-2 Problem - 4, OpenMP Guided Scheduling
...
int main(int argc, char* argv[])
{
  ...
  sum = 0.0;
#pragma omp parallel for shared(a,b,N) private(k, tid) schedule(guided, 10000) reduction(+:sum)
