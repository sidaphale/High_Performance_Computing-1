...
int main(int argc,char* argv[])
{
  ...
  std::ofstream write_colintel ("Run2.dat");
  assert(write_colintel.is_open());
  write_colintel << "Time taken when looped over column first and then row with intel compiler = " << time_s << "\n";
