...
int main(int argc,char* argv[])
{
  ...
  std::ofstream write_rowgcc("Run3.dat");
  assert(write_rowgcc.is_open());
  write_rowgcc << "Time taken when first looped over row and then column with gcc compiler = " << time_s << "\n";
